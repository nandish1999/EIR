...
REPORT_PATH = os.path.join(PROJECT_ROOT, "candidateK_before_after_evaluation_report.md")
...
def generate_report(fidelity, readability, n_nodes, n_images, n_planets):
    ...
    md = f"""# Candidate K Before/After Evaluation Report

> **Project**: ButterflyClusterViz (Unity 3D)
> **Generated**: {now}
> **Script**: `scripts/candidateK_before_after_evaluation.py`
> **Data**: `Assets/StreamingAssets/Data/unity_pruned_density_tree_3d.csv`
...
*Report generated automatically by `scripts/candidateK_before_after_evaluation.py`*
"""
    return md
